...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "character_edit_work_button": "编辑作品",
        ...
        "dialog_close_tooltip": "关闭",
        "dialog_work_list_title": "编辑作品",
        "dialog_work_list_edit_title_button": "编辑作品",
        "dialog_work_list_edit_button": "编辑别名",
        "dialog_work_alias_title": "编辑作品别名",
        "dialog_work_alias_add": "添加作品别名",
        "dialog_work_alias_save": "保存",
        "dialog_work_title_title": "编辑作品",
        "dialog_work_title_placeholder": "请输入作品名",
        "dialog_work_title_save": "保存",
        "dialog_work_title_conflict_title": "作品名冲突",
        "dialog_work_title_conflict_message": "检测到已有同名作品“{name}”，是否继续？",
        "dialog_work_title_conflict_confirm": "继续编辑",
        "dialog_work_title_conflict_cancel": "取消",
        "dialog_work_title_overwrite_alias_title": "覆盖作品别名确认",
        "dialog_work_title_overwrite_alias_message": "将使用当前作品别名覆盖“{name}”已有别名。",
        "dialog_work_title_overwrite_alias_hint": "请确认以下差异后再执行覆盖。",
        "dialog_work_title_overwrite_confirm": "确认覆盖",
        "dialog_work_title_overwrite_cancel": "取消",
        "status_character_work_no_source": "当前角色库暂无可编辑作品。",
        "status_character_work_alias_required": "请至少保留一个作品别名。",
        "status_character_work_title_required": "作品名不能为空。",
        "status_character_work_updated": "已同步更新作品：{name}（影响 {count} 个角色）。",
        "status_character_work_update_failed": "更新作品失败：{error}",
        ...
        "tag_editor_search_placeholder": "搜索特征或角色",
    ...
    "en-US": {
        ...
        "character_edit_work_button": "Edit Works",
        ...
        "dialog_close_tooltip": "Close",
        "dialog_work_list_title": "Edit Works",
        "dialog_work_list_edit_title_button": "Edit Work",
        "dialog_work_list_edit_button": "Edit Aliases",
        "dialog_work_alias_title": "Edit Work Aliases",
        "dialog_work_alias_add": "Add Work Alias",
        "dialog_work_alias_save": "Save",
        "dialog_work_title_title": "Edit Work",
        "dialog_work_title_placeholder": "Enter work title",
        "dialog_work_title_save": "Save",
        "dialog_work_title_conflict_title": "Work Title Conflict",
        "dialog_work_title_conflict_message": "A work named \"{name}\" already exists. Continue?",
        "dialog_work_title_conflict_confirm": "Continue",
        "dialog_work_title_conflict_cancel": "Cancel",
        "dialog_work_title_overwrite_alias_title": "Confirm Alias Overwrite",
        "dialog_work_title_overwrite_alias_message": "Current aliases will overwrite existing aliases of \"{name}\".",
        "dialog_work_title_overwrite_alias_hint": "Review the differences below before overwrite.",
        "dialog_work_title_overwrite_confirm": "Overwrite",
        "dialog_work_title_overwrite_cancel": "Cancel",
        "status_character_work_no_source": "No works available to edit in current library.",
        "status_character_work_alias_required": "Keep at least one work alias.",
        "status_character_work_title_required": "Work title cannot be empty.",
        "status_character_work_updated": "Work updated: {name} (affected {count} characters).",
        "status_character_work_update_failed": "Failed to update work: {error}",
        ...
        "tag_editor_search_placeholder": "Search features or characters",
...
CHARACTER_LIBRARY_TRANSLATION_OVERRIDES: dict[str, dict[str, str]] = {
    "ja-JP": {
        ...
        "character_edit_work_button": "作品を編集",
    ...
    "ko-KR": {
        ...
        "character_edit_work_button": "작품 편집",
