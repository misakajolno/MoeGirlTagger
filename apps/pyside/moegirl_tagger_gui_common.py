...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "en-US": {
        ...
        "character_search_placeholder": "Search by character or work name",
        "character_search_button": "Search Character",
...
CHARACTER_LIBRARY_TRANSLATION_OVERRIDES: dict[str, dict[str, str]] = {
    ...
    "ko-KR": {
        ...
        "character_search_button": "캐릭터 검색",
