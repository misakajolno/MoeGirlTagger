...
class MoeGirlTaggerWindowUiMixin:
    ...
    def _init_ui(self) -> None:
        ...
        self.edit_tags_button.clicked.connect(self._open_batch_tag_editor_dialog)
        ...
        self.list_widget.selectionModel().selectionChanged.connect(self._on_analysis_selection_changed)
        self.list_widget.deleteRequested.connect(self._delete_image_by_key)
        self.list_widget.tagEditRequested.connect(self._open_tag_editor_dialog)
    ...
    def _build_analysis_page(self) -> QWidget:
        ...
        self.edit_tags_button = QPushButton()
        self.edit_tags_button.setObjectName("SecondaryButton")
        ...
        self.edit_tags_button.setFixedHeight(38)
        ...
        self.analysis_list_select_all_shortcut = QShortcut(QKeySequence.SelectAll, self.list_widget)
        self.analysis_list_select_all_shortcut.activated.connect(self.list_widget.selectAll)
    ...
    def _apply_language(self) -> None:
        ...
        self.edit_tags_button.setText(self._tr("btn_edit_tags"))
